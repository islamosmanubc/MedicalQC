"""Federated training entrypoint using Hydra and MLflow (canonical src)."""
...
def main(cfg: DictConfig) -> None:
    ...
    logger = get_logger("train_federated", rank=0, client_id="server")
    ...
    for hid, idxs in hospital_map.items():
        ...
        if hid in holdout_ids:
            holdout_loaders[hid] = loader
            continue
        client_model = QCFederatedMILModel(model_cfg)
        ...
        client = FederatedClient(
            ...
            cfg=ClientConfig(
                ...
                local_epochs=app_cfg.federated.local_epochs,
    ...
    history = run_federated(
        ...
        cfg=RunnerConfig(
            rounds=app_cfg.federated.rounds,
