...
from src.models.lora import LoraConfig, inject_lora, private_state_dict, shared_state_dict, load_private_state_dict
...
def test_lora_state_split_and_reload():
    ...
    model2 = TinyBlock()
    inject_lora(model2, LoraConfig(r=2, alpha=4.0, dropout=0.0, target_modules=("qkv", "proj")))
